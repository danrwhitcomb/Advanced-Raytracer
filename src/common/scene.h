...
// Mesh Skinning Data
struct MeshSkinning {
    vector<vec3f>           vert_rest_pos;      // rest pos
    vector<vec3f>           vert_rest_norm;     // rest norm
    vector<vec4i>           vert_bone_ids;      // skin bones
    vector<vec4f>           vert_bone_weights;  // skin weights
